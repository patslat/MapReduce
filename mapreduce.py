...
def mapfn(k, v):
    ...
    authors = datum.pop().split('::')
    for author in authors:
        for word, frequency in word_count.items():
            yield author, [word, frequency]
...
results = s.run_server(password="derp")
print results
